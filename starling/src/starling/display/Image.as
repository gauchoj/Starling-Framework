...
package starling.display
{
	...
	public class Image extends Quad
	{
		...
		public static function fromBitmap(bitmap:Bitmap, generateMipMaps:Boolean = false, scale:Number = 1):Image
		{
		...
		public override function render(support:RenderSupport, parentAlpha:Number):void
		{
			...
			//print(StarlingUtils.dumpChildren(this, ".", false, false)); 				
			//var testChild:Object = this;
			//while (testChild.parent) {								
			//print(testChild, testChild.name);  
