...
package starling.events
{
    ...
    public final class TouchPhase
    {
        ...
        /** The finger touched the printscreen just now, or the mouse button was pressed. */
        public static const BEGAN:String = "began";
        
        /** The finger moves around on the printscreen, or the mouse is moved while the button is
         *  pressed. */
        ...
        /** The finger was lifted from the printscreen or from the mouse button. */
